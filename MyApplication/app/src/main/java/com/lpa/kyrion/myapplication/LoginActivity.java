...
public class LoginActivity extends AppCompatActivity {
    ...
    // UI references.
    private AutoCompleteTextView ACLlogin;
    ...
    private void attemptLogin() {
        ...
        // Store values at the time of the login attempt.
         login = ((TextView) findViewById(R.id.txtLogin)).getText().toString();
        ...
        if (TextUtils.isEmpty(login)) {
            ACLlogin.setError("Login cannot be empty");
            focusView = ACLlogin;
            cancel = true;
        } else if (!isLoginValid(login)) {
            ACLlogin.setError("Login has an invalid pattern");
            focusView = ACLlogin;
            cancel = true;
        }
    ...
    private boolean isLoginValid(String login) {
        ...
        boolean match = Pattern.matches(regex,login);
        return match;
    }
                        ...
                        public void onResponse(Call call, final Response response) throws IOException {
                            ...
                            runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    getParentActivityIntent().putExtra(MainActivity.response,text);
                                    finish();
                                }
                            });
                        }
